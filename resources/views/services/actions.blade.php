<div class="d-flex justify-content-center">
    ...
    <ul class="dropdown-menu dropdown-menu-end px- py-3 me-sm-n4 border" aria-labelledby="dropdownMenuButton">
        <li class="mb-2">
            <a class="dropdown-item border-radius-md" href="{{ route('services.show', $id) }}">
                <span class="text-sm">{{ __('show') }}</span>
            </a>
        </li>
        <li class="mb-2">
            <a class="dropdown-item border-radius-md" href="{{ route('services.edit', $id) }}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-wrap" id="exampleModalLabel">{{ __('delete_service_modal') }}</h5>
            ...
            <div class="modal-footer">
                ...
                <form method="post" action="{{ route('services.destroy', $id) }}">
                    @method('delete')
                    @csrf
