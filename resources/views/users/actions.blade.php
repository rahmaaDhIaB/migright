<div class="d-flex justify-content-center">
    ...
    <ul class="dropdown-menu  dropdown-menu-end  px- py-3 me-sm-n4  border" aria-labelledby="dropdownMenuButton">
        <li class="mb-2">
            <a class="dropdown-item border-radius-md" href="{{route('admins.show',$id)}}">
                <span class="text-sm">{{__('show')}}</span>
            </a>
        </li>
        <li class="mb-2">
            <a class="dropdown-item border-radius-md"  href="{{route('admins.edit',$id)}}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form
                    method="post" action="{{route('admins.destroy',$id)}}"
                >
                    @method('delete')
                    @csrf
