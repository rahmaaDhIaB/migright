<div class="d-flex justify-content-center">
    ...
    <ul class="dropdown-menu  dropdown-menu-end  px- py-3 me-sm-n4  border" aria-labelledby="dropdownMenuButton">
        <li class="mb-2">
            <a class="dropdown-item border-radius-md" href="{{ request()->has('status') && request()->query('status') == 'pending' ? route('testimony.show', ['id' => $id, 'status' => 'pending']) : route('testimony.show', $id) }}">
        ...
        @if(auth()->user()->is_admin)
            <li class="mb-2">
                <a class="dropdown-item border-radius-md" href="{{route('testimony.edit',$id)}}">
            ...
            <li class="mb-2">
                <a class="dropdown-item border-radius-md"
                   href="{{route('testimony.assignTestimonyDemandToUser.create',$id)}}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-wrap" id="exampleModalLabel">{{__('delete_testimony_modal')}}</h5>
            ...
            <div class="modal-footer">
                ...
                <form
                    method="post" action="{{route('testimony.destroy',$id)}}"
                >
                    @method('delete')
                    @csrf
