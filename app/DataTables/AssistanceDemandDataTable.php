...
class AssistanceDemandDataTable extends DataTable
{
    /**
     ...
     */
    public function query(AssistanceDemand $model): QueryBuilder
    {
        ...
        ->where('demands.demandable_type', '=', AssistanceDemand::class);
    ...
    public function getColumns(): array
    {
        ...
        if ($status === 'pending') {
            $columns = array_merge($columns, [
                ...
                Column::make('demand.phone_number')->title(__('phone number'))->addClass('text-center'),
               ...
               $columns = array_merge($columns, [
                 Column::make('id')->title(__('ID'))->addClass('text-center'),
                   Column::make('created_at')->title(__('Date'))->addClass('text-center'),
                   Column::make('phone_number')->title(__('phone_number'))->addClass('text-center'),
    ...
    {
        return 'AssistanceDemand_' . date('YmdHis');
    }
}
